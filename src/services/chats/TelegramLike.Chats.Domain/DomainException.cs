namespace TelegramLike.Chats.Domain;

/// <summary>
/// Base type for deliberate business-rule violations raised by the domain / application layer
/// (e.g. "chat not found", "only Owner or Admin can kick", "chat name cannot be empty").
...
/// Replaces the previous raw <see cref="UnauthorizedAccessException"/> for membership/role checks.
/// </summary>
