...
namespace TelegramLike.Presence.Tests.Api.Harness;

/// <summary>
/// Shared WebApplicationFactory for Presence Api integration tests.
...
/// Provides test JWT config and a real HMAC JWT minter so requests exercise
/// the actual JwtBearer pipeline (all /presence endpoints are authed).
/// </summary>
public sealed class PresenceApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("MongoDB:DatabaseName", "test_presence");
        ...
        builder.ConfigureTestServices(services =>
        {
            ...
            // Strip hosted services (MassTransit bus, any future initializer) so the test
            // host starts instantly and touches no infrastructure. Same pattern as
            // MessagingApiFactory.
