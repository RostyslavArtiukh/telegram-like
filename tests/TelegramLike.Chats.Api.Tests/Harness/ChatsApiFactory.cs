...
namespace TelegramLike.Chats.Api.Tests.Harness;

/// <summary>
/// Shared WebApplicationFactory for Chats Api integration tests.
...
/// </summary>
public sealed class ChatsApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("MongoDB:DatabaseName", "test_chats");
