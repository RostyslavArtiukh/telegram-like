...
namespace TelegramLike.Notifications.Tests.Api.Harness;

/// <summary>
/// Shared WebApplicationFactory for Notifications Api integration tests.
...
/// the actual JwtBearer pipeline (all /notifications endpoints are authed).
/// </summary>
public sealed class NotificationsApiFactory : WebApplicationFactory<Program>
{
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.UseSetting("MongoDB:DatabaseName", "test_notifications");
