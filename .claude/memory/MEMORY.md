...
- [maintainability_review_fixes.md](maintainability_review_fixes.md) — Аудит підтримуваності 2026-08-02: 4 фікси [TL-117..120] (wire-імена подій / recipients лише в Messaging / декларативні Mongo-індекси / shared-шар як NuGet+semver); свідомо прийняті компроміси й список масштабованості, який ще не робили
