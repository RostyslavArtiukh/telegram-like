...
- [maintainability_review_fixes.md](maintainability_review_fixes.md) — Аудит підтримуваності 2026-08-02: 4 фікси [TL-117..120] (wire-імена подій / recipients лише в Messaging / декларативні Mongo-індекси / shared-шар як NuGet+semver); свідомо прийняті компроміси
- [scalability_ceilings_fixed.md](scalability_ceilings_fixed.md) — Раунд масштабованості [TL-121..128]: індекси+плани запитів / fan-out подій частинами / outbox без poll-такту / витік pubsub у BFF / realtime питає членство замість реплікації / rate limiting на gateway; що віддали натомість
